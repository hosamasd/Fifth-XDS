...
//                .animation(.easeOut(duration: 0.25))
            ...
            Circle()
                ...
                .animation(Animation.easeOut(duration: 0.25).delay(0.25))
            ...
            Circle()
                ...
                .offset(x: gradualAnimation ? 0 : 55)
                .rotationEffect(.degrees(45))
                .animation(Animation.easeOut(duration: 0.25).delay(0.75))
            ...
            Circle()
                ...
                .scaleEffect(gradualAnimation ? 0.5 : 1)
                .offset(y: gradualAnimation ? 0 : 55)
                .animation(Animation.linear(duration: 0.25).delay(1))
            ...
            Circle()
                ...
                .offset(y: gradualAnimation ? 0 : 55)
                .rotationEffect(.degrees(45))
                .animation(Animation.easeOut(duration: 0.25).delay(1.25))
            ...
            Circle()
                ...
                .scaleEffect(gradualAnimation ? 0.5 : 1)
                .offset(x: gradualAnimation ? 0 : -55)
                .animation(Animation.easeOut(duration: 0.25).delay(1.5))
            ...
            Circle()
                ...
                .offset(y: gradualAnimation ? 0 : -55)
                .rotationEffect(.degrees(-45))
                .animation(Animation.easeOut(duration: 0.25).delay(1.75))
