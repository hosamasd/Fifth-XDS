    ...
    var body: some View {
        ...
        ZStack{
            ...
            Circle()
                ...
                .animation(Animation.easeInOut(duration: 1).delay(1).repeatForever(autoreverses: false))
            ...
            Circle()
                ...
                .offset(y: -90)
                .rotationEffect(.degrees(Double(loadingAnimation)))
                .animation(Animation.easeInOut(duration: 1.1).delay(0.9).repeatForever(autoreverses: false))
            ...
            Circle()
                ...
                .offset(y: -90)
                .rotationEffect(.degrees(Double(loadingAnimation)))
                .animation(Animation.easeInOut(duration: 1.2).delay(0.8).repeatForever(autoreverses: false))
            ...
            Circle()
                ...
                .offset(y: -90)
                .rotationEffect(.degrees(Double(loadingAnimation)))
                .animation(Animation.easeInOut(duration: 1.3).delay(0.7).repeatForever(autoreverses: false))
            ...
            Circle()
                ...
                .offset(y: -90)
                .rotationEffect(.degrees(Double(loadingAnimation)))
                .animation(Animation.easeInOut(duration: 1.4).delay(0.6).repeatForever(autoreverses: false))
